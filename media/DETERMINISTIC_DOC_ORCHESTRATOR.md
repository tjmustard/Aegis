...
Aegis v0.4.2 is a mature, production-grade system that the designer has used to generate 40+ real job applications. It works. It eliminates hallucination. It produces ATS-optimized PDFs in a single Claude Code session. It is the proof of concept that the architecture described in this document is sound.
...
*Project Aegis v0.4.2 was developed by Thomas J. L. Mustard. Repository: https://github.com/tjmustard/Aegis. This document describes the design vision for its successor project, deterministic-doc-orchestrator.*
